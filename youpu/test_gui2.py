        ...
        if self.vertical:
            if abs(y - y0) > 20 or len(self.lines_list) == 1:
                ...
                if abs(x - x0) > 20:
                    ...
                    self.lines_list.append(self.canvas.create_line(coords[2], coords[3], x, coords[3], arrow='last',
                                                                   arrowshape=(8, 15, 3)))
            elif abs(y - y0) < 20:
            ...
            if abs(x - x0) > 20 or len(self.lines_list) == 1:
                ...
                if abs(y - y0) > 20:
                    self.vertical = not self.vertical
                    self.canvas.itemconfig(l, arrow='')
                    self.lines_list.append(self.canvas.create_line(coords[2], coords[3], coords[2], y, arrow='last',
                                                                   arrowshape=(8, 15, 3)))
