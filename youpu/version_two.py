...
if __name__ == '__main__':
    ...
    request = requests.get(
        "http://route.xiongmaodaili.com/xiongmao-web/api/glip?secret=88d304d14273946c00cd3cabc7d25199&orderNo=GL20201208142456Pe5sEDu6&count=2&isTxt=0&proxyType=1")
    ...
    for i in range(1):
        ...
        port = ip_port['obj'][rand]['port']
        ip = ip_port['obj'][rand]['ip']
