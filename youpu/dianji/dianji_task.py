...
class oneThread(threading.Thread):
    ...
    def __init__(self, word_one, site, arg1, ip, city, county, citycookies, show_window, proxies, n, arg_x, ip_min,
                 total_loop_count, use_cookie, cities):
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                # 去掉城市名
                change_keyword = str(word["keyword"])
                ...
                uri = "https://www.baidu.com/s?ie=UTF-8&wd=" + change_keyword + "&si=" + self.site + "&ct=2097152"
                driver.get(uri)
                ...
                # 滚动下
                js = "document.documentElement.scrollTop=document.body.scrollHeight/10*" + random.randint(2, 6)
