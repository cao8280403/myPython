...
class Fetchip:
    def __init__(self,num):
        ...
        self.url = "http://api.zhuzhaiip.com:498/GetIpPort?passageId=1335483186735783938&num="+num+"&protocol=2&province=&city=&minute=1&format=2&split=&splitChar=&reset=true&secret=CZj0Zd&isorigin_ip=1"
