...
class Fetchip:
    def __init__(self, num):
        ...
        self.url = "http://napi.zhuzhaiip.com:9999/iplist?passageId=1335483186735783938&num=" + num + "&protocol=2&province=&city=&minute=3&format=2&split=&splitChar=&dedupe=3&secret=CZj0Zd"
